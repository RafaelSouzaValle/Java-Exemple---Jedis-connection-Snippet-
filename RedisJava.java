...
/**
 * 
 * Classe demonstrativa de utilização do Redis
 * (um banco de dados NoSQL chave-valor escrito em C,
 * cujo o armazenamento é feito na memória).
 * 
 *  Dependência necessária no arquivo pom.xml:
 *  <dependencies>
 *	<dependency>
 ...
 *</dependencies>
 * 
 *  Exemplo testado com uso do Redis na versão 2.4.5.
 *  Antes do código ser executado, é necessário que
 *  o server e o cliente do Redis estejam em execução.
 * 
 * @author Rafael.Valle
 *
 */
